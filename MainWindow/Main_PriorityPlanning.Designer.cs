...
namespace DigitalProductionProgram.MainWindow
{
    partial class Main_Priorityplanning
    {
        ...
        private void InitializeComponent()
        {
            ...
            tlp_Main.SetColumnSpan(label_ProductionSchedule, 2);
            ...
            label_ProductionSchedule.Size = new Size(342, 48);
            ...
            label_ProdGroup.Location = new Point(4, 88);
            label_ProdGroup.Margin = new Padding(4, 0, 4, 0);
            label_ProdGroup.Name = "label_ProdGroup";
            label_ProdGroup.Size = new Size(342, 32);
            label_ProdGroup.TabIndex = 6;
            label_ProdGroup.Text = "Välj ProduktionsGrupp eller ";
            // 
            // tlp_InfoLabels
            // 
            ...
            tlp_InfoLabels.Dock = DockStyle.Left;
            ...
            tlp_Main.Controls.Add(tlp_InfoLabels, 2, 0);
            tlp_Main.Controls.Add(tb_ProdBenämning, 1, 3);
            tlp_Main.Controls.Add(label_ProdGroup, 0, 2);
            tlp_Main.Controls.Add(tb_ProdGrupp, 0, 3);
            ...
            tlp_Main.RowCount = 4;
            tlp_Main.RowStyles.Add(new RowStyle(SizeType.Absolute, 48F));
            ...
            tlp_Main.Size = new Size(1202, 140);
            tlp_Main.TabIndex = 10;
            // 
            // tb_ProdBenämning
            // 
            tb_ProdBenämning.Dock = DockStyle.Fill;
            tb_ProdBenämning.Location = new Point(70, 120);
            tb_ProdBenämning.Margin = new Padding(0);
            ...
            tb_ProdGrupp.Location = new Point(0, 120);
            tb_ProdGrupp.Margin = new Padding(0);
            tb_ProdGrupp.Name = "tb_ProdGrupp";
            tb_ProdGrupp.ReadOnly = true;
            tb_ProdGrupp.Size = new Size(70, 23);
            ...
            tlp_Main.SetColumnSpan(btn_RefreshPriorityPlan, 2);
            ...
            btn_RefreshPriorityPlan.Location = new Point(2, 48);
            btn_RefreshPriorityPlan.Margin = new Padding(2, 0, 0, 0);
            btn_RefreshPriorityPlan.Name = "btn_RefreshPriorityPlan";
            btn_RefreshPriorityPlan.Size = new Size(348, 40);
            ...
            dgv_PriorityPlanning.Location = new Point(0, 140);
            dgv_PriorityPlanning.Margin = new Padding(6, 3, 4, 12);
            ...
            dgv_PriorityPlanning.Size = new Size(1202, 278);
